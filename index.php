...
<html>
    <head>
        ...
        <meta property="og:title" content="Malmö — electronic music" />
        <meta property="og:description" content="Ambient, electronica, and felted techno are joined together to give life to evading music and performances" />
        ...
        <meta name="twitter:title" content="Malmö — electronic music">
        <meta name="twitter:description" content="Ambient, electronica, and felted techno are joined together to give life to evading music and performances">
            ...
            <div class="container">
                <header class="header">
                    <figure class="header__logo">
                        <img src="library/built/img/malmo-logo.png" alt="Malmö">
                    </figure>
                ...
                <section class="cntent">
                    <div class="columns">
                        <div class="column is-7">
                            <h3 class="cntent__title">Lost in north.</h3>

                            <div class="cntent__text">
                                <p>Inspired by the peaceful Scandinavian landscapes, the musical project Malmö takes its name from this famous Swedish city, a place of exchange and dialogue connecting Denmark via the Oresund detroit.</p>
                                <p>Through his compositions, the Parisian producer creates tactful melodies which are finely cadenced by wooly beats. Ambient, electronica, and felted techno are joined together to give life to evading tracks.</p>
                            </div>
                        </div>
                        <div class="column is-1"></div>
                        <div class="column is-4">
                            <div class="cntent__player">
                                <iframe style="border: 0;" src="https://bandcamp.com/EmbeddedPlayer/album=1439854761/size=large/bgcol=ffffff/linkcol=333333/minimal=true/transparent=true/" seamless></iframe>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <footer class="footer">
                    <div class="footer__link">
                        contact (booking/other): <a href="mailto:malmo@hej-malmo.se">malmo@hej-malmo.se</a>
                    </div>
                </footer>
            </div>
        </main>
